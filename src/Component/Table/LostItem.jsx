    ...
    return (
      <Fragment>
        <Card className="card-wrapped">
          <Col xs="4" sm="4" className="text-left pl-0 pr-0">
            <CardImg src={image} alt="image post" className="pl-0 pr-0" />
          </Col>
          <Col xs="8" sm="8">
            <Col xs="12" sm="12" className="pl-0 pr-0 card-content">
              <CardHeader className="pl-0 pr-0 pt-0">
                <CardTitle className="item-title d-flex flex-row justify-content-between text-capitalize">
                  {title}
                  <Badge color="info">Share</Badge>
                </CardTitle>
              </CardHeader>
              ...
              <CardFooter className="item-attribute pl-0 pr-0">
                <Col sm="10" md="4" className="pr-0 pl-0 text-left">
                ...
                <Col sm="1" md="4" className="pl-1 pr-0 text-left">
